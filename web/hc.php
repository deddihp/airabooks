		...
		<script src="highchart.js" type="text/javascript"></script>

        <?php

        // Include the library
        require_once('hc/src/highcharts.php');


        // Start by adding a new reference object
        // and adding some configuration for the chart
        $oHighcharts = new Highcharts(new HighchartsChart('container', HighchartsChart::SERIES_TYPE_BAR));
